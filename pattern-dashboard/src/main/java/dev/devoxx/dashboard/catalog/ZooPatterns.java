...
import dev.devoxx.dashboard.agents.zoo.FirstMeal;
import dev.devoxx.dashboard.agents.zoo.FirstTraining;
import dev.devoxx.dashboard.agents.zoo.GardenRecall;
import dev.devoxx.dashboard.agents.zoo.HolidayVerdict;
import dev.devoxx.dashboard.agents.zoo.HomeNotes;
import dev.devoxx.dashboard.agents.zoo.IndoorRecall;
import dev.devoxx.dashboard.agents.zoo.LeaveHimAdvocate;
import dev.devoxx.dashboard.agents.zoo.MoneyAndVet;
import dev.devoxx.dashboard.agents.zoo.ParkRecall;
import dev.devoxx.dashboard.agents.zoo.PuppyBook;
import dev.devoxx.dashboard.agents.zoo.RoutineNotes;
import dev.devoxx.dashboard.agents.zoo.SpaceAndTime;
import dev.devoxx.dashboard.agents.zoo.TakeHimAdvocate;
import dev.devoxx.dashboard.agents.zoo.TeamOnTheBed;
import dev.devoxx.dashboard.agents.zoo.TeamOnTheFloor;
import dev.devoxx.dashboard.agents.zoo.ToiletTrip;
import dev.devoxx.dashboard.agents.zoo.TrainerLead;
import dev.devoxx.dashboard.agents.zoo.TrainerOnCall;
import dev.devoxx.dashboard.agents.zoo.VetOnCall;
import dev.devoxx.dashboard.agents.zoo.WalkNotes;
import dev.devoxx.dashboard.catalog.PatternDef.Runner;
import dev.devoxx.dashboard.planner.EscalationPlanner;
