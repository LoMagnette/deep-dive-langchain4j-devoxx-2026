...
final class CompositePatterns {
    ...
    private static PatternDef sitterNote() {
        ...
        Runner runner = (model, input, listener) -> {
            ...
            var meals = agent(Agents.MealPlanner.class, model, "MealPlanner", "meals");
            var walks = agent(Agents.WalkPlanner.class, model, "WalkPlanner", "walks");
            ...
            var tighten = agent(Agents.NoteTightener.class, model, "NoteTightener", "note");
            ...
            var merge = agent(Agents.SitterNoteMerger.class, model, "SitterNoteMerger", "note");
    ...
    private static PatternDef secondDogCouncil() {
        ...
        Runner runner = (model, input, listener) -> {
            ...
            var scout = agent(Agents.AngleScout.class, model, "AngleScout", "finding");
            ...
            var forIt = agent(Agents.SecondDogFor.class, model, "SecondDogFor", null);
            var against = agent(Agents.SecondDogAgainst.class, model, "SecondDogAgainst", null);
            var chair = agent(Agents.HouseholdVerdict.class, model, "HouseholdVerdict", "verdict");
            ...
            var note = agent(Agents.CouncilNote.class, model, "CouncilNote", "household");

            // 5. Voting (advanced) — the same three assessors the voting demo used, now
            //    ratifying a debated motion instead of voting cold.
            var space = agent(Agents.SpaceAndTime.class, model, "SpaceAndTime", null);
            var money = agent(Agents.MoneyAndVet.class, model, "MoneyAndVet", null);
            var zao = agent(Agents.AskZaoHimself.class, model, "AskZaoHimself", null);
